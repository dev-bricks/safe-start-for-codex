...
Stand: 2026-09-16
Aktueller dokumentierter Release: `v1.1.6`
...
- Der aktuelle dokumentierte Release-Stand ist `v1.1.6` vom 2026-09-16.
...
- Ein Live-GitHub-Tag-Readback für `v1.1.6` bleibt erforderlich, bevor der
...
|---|---|---|---|
| `v1.1.6` | 2026-09-16 | GitHub | Pfad A Technische Hygiene: CI-Workflow-Härtung (stale.yml, welcome.yml, 15m Timeout), Pytest-Guardrails, .gitignore Multi-Host Schutz, Vertragstests |
